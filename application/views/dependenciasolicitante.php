...
<head>
	...
	<title>Transparencia Publicidad</title>
        ...
        $(document).ready(function(){
		   $('#tabla_lista_dependencias_solicitantes').dataTable( { //CONVERTIMOS NUESTRO LISTADO DE LA FORMA DEL JQUERY.DATATABLES- PASAMOS EL ID DE LA TABLA
...
<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php base_url() ?>" data-via="oaxtransparente" data-lang="es" data-text="Dependencias solicitantes | #Transparencia en #Publicidadoficial del @GobOax">Twittear</a>
...
<td width="20%"><div><a href="<?php echo base_url()?>index.php/dependencias/cargar/<?=$anio?>" style="color:#8D8D8D">Dependencia contratante</a></div></td> <td width="20%" class="rellenar_dependencia"><div><a href="<?php echo base_url()?>index.php/dependencias/cargar_solicitantes/<?=$anio?>" style="color:#fff">Dependencia solicitante</a></div></td><td width="60%"></td>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_dependencias_solicitantes" style="margin-bottom:0px;">
                <thead>                	
                    <tr>
                ...
                <tfoot>               
                  ...
                  <div style="margin-bottom:0px;" > </div>                                                                                            
                   ...
                   { ?>
                               <tr>
                               <td class="leftb"> <a href="../detalle_dependencia_solicitante/<?php echo $fila->id_dependencia ?>/<?php echo $fila->anio?>"><?php echo mb_convert_encoding($fila->dependencia, "UTF-8")?></a> </td>
