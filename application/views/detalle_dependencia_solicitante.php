...
<head>
	...
	<title>Transparencia Publicidad</title>
        ...
        $(document).ready(function(){
           $('#tabla_lista_campas_dependencia_solicitante').dataTable( { //CONVERTIMOS NUESTRO LISTADO DE LA FORMA DEL JQUERY.DATATABLES- PASAMOS EL ID DE LA TABLA
...
<br>
 ...
 <table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_campas_dependencia_solicitante" style="margin-bottom:0px;">
                <thead>                	
                    <tr>
