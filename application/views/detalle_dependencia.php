...
<head>
	...
	<title>Transparencia Publicidad</title>
        ...
        <!--script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>listado/js/funcionescampa.js"></script>
        <!--    JQUERY    -->
        <!--    FORMATO DE TABLAS    -->
        ...
        $(document).ready(function(){
           $('#tabla_lista_campas_dependencia').dataTable( { //CONVERTIMOS NUESTRO LISTADO DE LA FORMA DEL JQUERY.DATATABLES- PASAMOS EL ID DE LA TABLA
...
<td class="con_raya"> <label class="letra"> Campañas </label> <br> realizadas <br> <label class="numero"> <?php echo $numero_campas; ?> </label> </td> <td> <label class="letra"> Gasto </label> <br> total <br><label class="numero"> $<?php echo number_format($monto_gastado); ?> </label> </td> 
