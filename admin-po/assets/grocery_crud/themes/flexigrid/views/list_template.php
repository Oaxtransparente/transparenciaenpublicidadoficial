...
<div class="flexigrid" style='width: 100%;'>
	<div class="mDiv">
		<div class="ftitle" style="color:#fff;">
        <?php echo ucwords($subject)."s";?>
			&nbsp;            
		</div>
	...
	<div class="pDiv">
		<div class="pDiv2">
			...
			<div class="pGroup">
				<span class="pcontrol"><?php echo "Página";/*$this->l('list_page');*/ ?> <input name='page' type="text" value="1" size="4" id='crud_page'> 
