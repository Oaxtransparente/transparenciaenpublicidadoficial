...
<h2> Ingrese la nueva imagen testigo de la factura "<?php foreach($facturas->result() as $fila) { echo $fila->num_factura; }?>" </h2><br>
...
<tr><td valign="top" width="20%">Imágenes de testigo de la factura:</td><td> 
...
<input type="button" onclick=" location.href='<?php echo base_url();?>/index.php/imagenes_testigo_factura/principal/<?php echo $id;?>' " value="Cancelar" class="boton" /> 
