...
$imagenes = $imagenes.'<td> <img src="../../archivos/imagenes_factura/'.$Reg['imagen'].'" class="preview" > </td>';
										if($Reg['imagen']!=null)
$imagenes_borrar=$imagenes_borrar.'<td><a style="margin-right:95px;" class="eliminar_imagen_factura" id="eliminar_imagen_factura"  href="javascript:void(0);" onclick="eliminar_imagen_factura('.$Reg['id_imagen_factura'].')" value="'.$Reg['id_imagen_factura'].'" >Borrar</a></td>';                             
