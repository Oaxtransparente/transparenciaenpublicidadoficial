					...
					if($size<(1024*1024))
						{
							...
							if(copy($tmp, $path.$actual_image_name))
								{																	
									...
									mysql_query("insert into imagenes_factura_temp (id_factura,imagen) values (0,'$actual_image_name')", $db);
...
$imagenes_borrar=$imagenes_borrar.'<td><a style="margin-right:95px;" class="eliminar_nueva_imagen_factura" href="javascript:void(0);" onclick="eliminar_nueva_imagen_factura('.$Reg['id_audio'].')" >Borrar</a></td>';                             
