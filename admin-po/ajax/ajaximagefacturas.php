...
$imagenes_borrar=$imagenes_borrar.'<td><a style="margin-right:95px;" class="eliminar_imagen_factura" href="javascript:void(0);"  onclick="eliminar_imagen_factura('.$Reg['id_imagen_factura'].')" >Borrar</a></td>';                             
