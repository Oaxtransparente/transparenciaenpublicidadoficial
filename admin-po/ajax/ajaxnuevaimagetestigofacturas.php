...
$imagenes_borrar=$imagenes_borrar.'<td><a style="margin-right:95px;" class="eliminar_nueva_imagen_testigo" href="javascript:void(0);" onclick="eliminar_nueva_imagen_testigo_factura('.$Reg['id_imagen_factura'].')">Borrar</a></td>';                              
